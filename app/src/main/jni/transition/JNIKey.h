...
JNIEXPORT jbyteArray JNICALL Java_co_jniwrappers_BRKey_compactSign(JNIEnv *env, jobject thiz,
        jbyteArray data);

JNIEXPORT jboolean JNICALL Java_co_jniwrappers_BRKey_setPrivKey(JNIEnv *env,
        jobject thiz,
        jbyteArray privKey);

JNIEXPORT void JNICALL Java_co_jniwrappers_BRKey_setSecret(JNIEnv *env,
        jobject thiz,
        jbyteArray privKey);
